...
public class MoneyBackupp {
	...
	public void nationHoldings() {
		...
		while (scanner.hasNextLine()) {
			...
			if (Methods.getMethod().hasAccount(accountName.toLowerCase())) {
				...
				if (balance > 100.0)
				printStream.println(name + ": " + balance);
			}
		}
		printStream.println("-----------------------------------------------");
	...
	public void nationAndTownWithSmallAmountOfMoney() {
		...
		long timeStart = System.currentTimeMillis();
		printStream.println("=================================");
		printStream.println("Nations with less than 1000Dollar");
		printStream.println("=================================");
		...
		printStream.println("");
		printStream.println("===============================");
		printStream.println("Towns with less than 1000Dollar");
		printStream.println("===============================");
