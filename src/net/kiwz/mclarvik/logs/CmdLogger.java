...
public class CmdLogger {
	...
	public void cmdLogger1(String player, String message) {
		...
		String fileName = mcLarvik.getConfig().getString("FileDir", "plugins/dynmap/web/admin") + "/logs/Cmd-Logger1.txt";
		Format sdf = new SimpleDateFormat(mcLarvik.getConfig().getString("TimeFormat", "yyyy-MM-dd HH:mm:ss"));
		Date date = new Date();
		String time = sdf.format(date);
		List<String> cmdsToLog = mcLarvik.getConfig().getStringList("CmdToLog1");
	...
	public void cmdLogger2(String player, String message) {
		...
		Plugin mcLarvik = Bukkit.getServer().getPluginManager().getPlugin("MCLarvik");
		String fileName = mcLarvik.getConfig().getString("FileDir", "plugins/dynmap/web/admin") + "/logs/Cmd-Logger2.txt";
		Format sdf = new SimpleDateFormat(mcLarvik.getConfig().getString("TimeFormat", "yyyy-MM-dd HH:mm:ss"));
		Date date = new Date();
		String time = sdf.format(date);
		List<String> cmdsToLog = mcLarvik.getConfig().getStringList("CmdToLog2");
		String[] msg = message.split(" ");
		String cmdToLog1 = "";
		String msg1 = "";
	...
	public void privMsgLogger(String player, String message) {
		...
		Plugin mcLarvik = Bukkit.getServer().getPluginManager().getPlugin("MCLarvik");
		String fileName = mcLarvik.getConfig().getString("FileDir", "plugins/dynmap/web/admin") + "/logs/Private-Msg.txt";
		Format sdf = new SimpleDateFormat(mcLarvik.getConfig().getString("TimeFormat", "yyyy-MM-dd HH:mm:ss"));
		Date date = new Date();
		String time = sdf.format(date);
		List<String> privMsgToLog = mcLarvik.getConfig().getStringList("PrivMsgToLog");
		String[] msg = message.split(" ");
